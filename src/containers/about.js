...
class About extends React.Component {
  ...
  Although based in Scotland, we have drawn talents from many different
  cultures and countries, reflecting the users that we serve. We all share a mission: a desire to provide security and privacy for
  everyone.
  </p>
							<div className="ques">
								<span>Interested in joining our diverse and growing team?</span>
				...
				<div id="what-drives-us" className="post-3">
					<div className="post-3-cont">
						<div className="post-3-cont-i">
							...
							<p>In our quest to provide privacy, security and freedom to everyone, we are creating an Open Source decentralised data network called Autonomi - and everyone’s welcome. Join us at <a href="https://safenetwork.tech">safenetwork.tech</a> </p>
						</div>
					</div>
					<div className="post-3-cont">
						<div className="post-3-cont-i">
